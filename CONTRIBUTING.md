...
## 1 Fork 代码
1. 访问 https://github.com/ego-component/ekafka
...
```bash
git clone https://github.com/ego-component/ekafka.git
cd ekafka
git remote add upstream 'git@github.com:<your github username>/ekafka.git'
```
...
## 6 提交 PR
访问 https://github.com/ego-component/ekafka, 
